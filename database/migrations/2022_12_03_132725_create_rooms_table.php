...
class CreateRoomsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('rooms', function (Blueprint $table) {
          ...
          $table->string('dep',30)->default('0');
          $table->bigInteger('Cleanup',false,true)->default(0);
          $table->bigInteger('Laundry',false,true)->default(0);
          $table->bigInteger('RoomService',false,true)->default(0);
          $table->string('RoomServiceText')->default('');
          $table->bigInteger('Checkout',false,true)->default(0);
          $table->bigInteger('Restaurant',false,true)->default(0);
          $table->bigInteger('MiniBarCheck',false,true)->default(0);
          $table->integer('Facility',false,true)->default(0);
          $table->bigInteger('SOS',false,true)->default(0);
          $table->bigInteger('DND',false,true)->default(0);
